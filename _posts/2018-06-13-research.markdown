...
<ul>
  <h5><b>Public Health Facilities in North India:An Exploratory Study in Four States</b>, (with <em>Reetika Khera</em>), (<a href="/files/epw_paper.pdf" target="_blank"><em>Draft</em></a>)  
