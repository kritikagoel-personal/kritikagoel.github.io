...
-->
 ...
 <h5><strong>Price Discrimination and Product Variety: the Case of Implantable Medical Devices</strong><em>(<a href="/files/jmp_draft10.pdf" target="_blank"><em>Link</em></a>)</em></h5>
